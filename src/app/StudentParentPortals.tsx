...
export function StudentPortal({ view, setView, onLogout, schoolId, user }: StudentPortalProps) {
  ...
  const studentRole = enrollmentQuery.enrollment?.classes?.name ? `Student - ${enrollmentQuery.enrollment.classes.name}` : "Student"
              ...
              <div className="space-y-5">
                ...
                <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    {gradesQuery.grades.length === 0 && <EmptyState title="No grade data yet" description="Final grades for this child will appear here once they are approved in Supabase." />}
                  </div>
                </div>
              </div>
            )}
