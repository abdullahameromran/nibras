...
const ARABIC_TRANSLATIONS: Record<string, string> = {
  ...
  "Question": "السؤال", "Question text": "نص السؤال", "Choice": "الاختيار", "Add Question": "إضافة سؤال", "Remove": "حذف", "Correct Answer": "الإجابة الصحيحة", "Deadline Date": "تاريخ التسليم", "Choose a CSV file": "اختر ملف CSV",
  ...
  "Create Lesson": "إنشاء درس", "Lesson Title": "عنوان الدرس", "Lesson Description": "وصف الدرس", "Lesson Date": "تاريخ الدرس", "Video URL": "رابط الفيديو", "Attachment": "المرفق", "Attachment Name": "اسم المرفق", "Attachment URL": "رابط المرفق", "Attachment Type": "نوع المرفق", "Add Attachment": "إضافة مرفق", "Save Lesson": "حفظ الدرس",
  ...
  "Create": "إنشاء", "All Results": "كل النتائج", "Subject": "المادة", "Type": "النوع", "Duration (minutes)": "المدة (بالدقائق)",
