...
const ARABIC_TRANSLATIONS: Record<string, string> = {
  "Choose a class and subject first.": "اختر الفصل والمادة أولًا.",
  "The selected class is not linked to an academic year.": "الفصل المحدد غير مرتبط بعام دراسي.",
  "Save and Approve": "حفظ واعتماد",
  "Edit Announcement": "تعديل الإعلان",
  "Save Draft": "حفظ كمسودة",
  "Announcement saved as draft": "تم حفظ الإعلان كمسودة.",
  "Class Announcement": "إعلان الفصل",
  "Announcement body": "نص الإعلان",
  "Complete the announcement form first.": "أكمل نموذج الإعلان أولًا.",
  "Unpublish": "إلغاء النشر",
  "Publish": "نشر",
  "Approve All Submitted": "اعتماد جميع الدرجات المرسلة",
  "Grades approved successfully": "تم اعتماد الدرجات بنجاح.",
  "Grade CSV imported. Review and save the drafts.": "تم استيراد ملف الدرجات. راجع المسودات ثم احفظها.",
  "CSV must include student_id and grade columns.": "يجب أن يحتوي ملف CSV على عمودي student_id وgrade.",
  "The CSV file has no grade rows.": "لا يحتوي ملف CSV على صفوف درجات.",
  "Broadcast to Class": "إرسال جماعي إلى فصل",
  "Broadcast to all students in this class": "إرسال جماعي إلى جميع طلاب هذا الفصل",
  "Grades Awaiting Approval": "درجات بانتظار الاعتماد",
  "Scored Submissions": "التسليمات المصححة",
  "Attendance Records": "سجلات الحضور",
  "Today's Classes": "حصص اليوم",
  "Pending Grading": "بانتظار التصحيح",
  "Homework Due": "الواجبات القادمة",
  "Broadcast to all teachers": "إرسال جماعي إلى جميع المعلمين",
  "Broadcast to all students": "إرسال جماعي إلى جميع الطلاب",
  "Broadcast to all parents": "إرسال جماعي إلى جميع أولياء الأمور",
  "Broadcast to class": "إرسال جماعي إلى الفصل",
  "Broadcast sent": "تم إرسال الرسالة الجماعية.",
  "Homework, test, and final-grade results for this child will appear here.": "ستظهر هنا نتائج الواجبات والاختبارات والدرجات النهائية لهذا الابن.",
  "Back to questions": "العودة إلى الأسئلة",
  "Submitting...": "جارٍ التسليم...",
  "No tests scheduled": "لا توجد اختبارات مجدولة",
  "Monthly tests for this subject will appear here once they are published.": "ستظهر الاختبارات الشهرية لهذه المادة هنا بعد نشرها.",
  "National ID": "الرقم القومي",
  "14 digits": "14 رقمًا",
  "National ID must contain exactly 14 digits.": "يجب أن يتكون الرقم القومي من 14 رقمًا.",
  "National ID must contain exactly 14 digits.c": "يجب أن يتكون الرقم القومي من 14 رقمًا.",
  "National ID must contain exactly 14 digits": "يجب أن يتكون الرقم القومي من 14 رقمًا.",
  "This National ID is already used by another student.": "هذا الرقم القومي مستخدم بالفعل لطالب آخر.",
  "This National ID is already used by another student": "هذا الرقم القومي مستخدم بالفعل لطالب آخر.",
  "This email already belongs to another active role in this school.": "هذا البريد الإلكتروني مرتبط بالفعل بحساب ذي دور آخر في هذه المدرسة.",
  ...
  "Students from your assigned classes are shown here.": "الطلاب المسجلون في الفصول المعيّنة لك يظهرون هنا.",
  "Upload file": "رفع ملف",
  ...
  "The selected file exceeds the 10 MB maximum size.": "يتجاوز الملف المحدد الحد الأقصى المسموح به وهو 10 ميجابايت.",
  ...
  "teacher_id must be an active teacher in the same school": "يجب أن يكون المعلم المحدد معلماً نشطاً في المدرسة نفسها.",
  "No conflict-free timetable entries could be generated for this class.": "تعذر إنشاء حصص لهذا الفصل دون تعارض مع جداول المعلمين الحالية.",
  "Timetable generated from live assignments": "تم إنشاء الجدول الدراسي بنجاح من تعيينات المعلمين.",
  ...
  "Academic Setup": "الإعداد الأكاديمي",
  "Grades & Classes": "الصفوف والفصول",
  Teachers: "المعلمون",
  Students: "الطلاب",
  Timetable: "الجدول الدراسي",
  "Final Grades": "الدرجات النهائية",
  "Scored Subjects": "المواد التي لها درجات",
  "Approved Grades": "الدرجات المعتمدة",
  Announcements: "الإعلانات",
  Messages: "الرسائل",
  "My Classes": "فصولي",
  "Tasks & Homework": "المهام والواجبات",
  "Tests & Quizzes": "الاختبارات",
  Results: "النتائج",
  Attendance: "الحضور",
  "My Courses": "مقرراتي",
  Homework: "الواجبات",
  ...
  "New User ? Sign Up": "مستخدم جديد؟ إنشاء حساب",
  Buttons: "الأزرار",
  "Sign Up": "إنشاء حساب",
  "Email/User ID": "البريد الإلكتروني / اسم المستخدم",
  Password: "كلمة المرور",
  "Keep me logged in": "تذكرني",
  "Forgot password": "نسيت كلمة المرور؟",
  "Log In": "تسجيل الدخول",
  "Enter registered email or user id": "أدخل البريد المسجل أو اسم المستخدم",
  "Enter password": "أدخل كلمة المرور",
  "Select your role to continue to your portal": "اختر دورك للمتابعة إلى بوابتك",
  ...
  "Recent Schools": "أحدث المدارس",
  "Schools by Plan": "المدارس حسب الباقة",
  ...
  Deactivate: "تعطيل",
  "Confirm Activation": "تأكيد التفعيل",
  ...
  Classes: "الفصول",
  "Configure Working Days": "إعداد أيام العمل",
  "Time Slots & Breaks": "الحصص وفترات الاستراحة",
  "Time Slots": "الحصص",
  ...
  "Save Drafts": "حفظ المسودات",
  "Submit for Approval": "إرسال للاعتماد",
  "Enter at least one final grade first.": "أدخل درجة نهائية واحدة على الأقل أولاً.",
  ...
  "Time is up. Review and submit your test.": "انتهى الوقت. راجع إجاباتك ثم سلّم الاختبار.",
  "Time is up. Review and submit your homework.": "انتهى الوقت. راجع إجاباتك ثم سلّم الواجب.",
  "Lesson marked as completed.": "تم تحديد الدرس كمكتمل.",
  "This test has no questions yet.": "لا يحتوي هذا الاختبار على أسئلة بعد.",
  "Test submitted successfully.": "تم تسليم الاختبار بنجاح.",
  "This homework has no questions yet.": "لا يحتوي هذا الواجب على أسئلة بعد.",
  "Homework submitted successfully.": "تم تسليم الواجب بنجاح.",
  Approve: "اعتماد",
  ...
  "Mark as break": "تحديدها كاستراحة",
  "No time slots configured yet.": "لا توجد حصص مهيأة بعد.",
  "Save Time Slot": "حفظ الحصة",
  "Save Working Days": "حفظ أيام العمل",
  ...
  "Tests This Month": "اختبارات هذا الشهر",
  "Upcoming Homework": "الواجبات القادمة",
  "No pending homework.": "لا توجد واجبات معلقة.",
  ...
  "Create a class announcement or save one as a draft.": "أنشئ إعلانًا للفصل أو احفظه كمسودة.",
  ...
  "Assigned Teachers": "المعلمون المعيّنون",
  "Employment Info": "بيانات الوظيفة",
  "Import CSV": "استيراد ملف بيانات",
  "Export CSV": "تصدير ملف بيانات",
  "Export PDF": "تصدير مستند",
  "Publish Timetable": "نشر الجدول",
  "Auto Generate": "إنشاء تلقائي",
  "Quick Actions": "إجراءات سريعة",
  "Recent Activity": "النشاط الأخير",
  "Recent Announcements": "أحدث الإعلانات",
  "Recent Assignments": "أحدث التكليفات",
  ...
  "Edit / Upgrade Plan": "تعديل / ترقية الباقة",
  ...
  "Upload PDF": "رفع PDF",
  "Upload PDF file": "رفع ملف مستند",
  Download: "تنزيل",
  "PDF Document": "مستند",
  "Homework Grades": "درجات الواجبات",
  "Student Submissions": "تسليمات الطلاب",
  "Submission Overview": "ملخص التسليمات",
  ...
  "No homework assigned yet": "لا توجد واجبات مسندة بعد",
  ...
  "Monthly Test": "الاختبار الشهري",
  "My Students": "طلابي",
  "Time Table": "الجدول الدراسي",
  "Ticketing System": "نظام الدعم",
  "School Dashboard": "لوحة تحكم المدرسة",
  "My Dashboard": "لوحتي",
  "School Administrator": "مدير المدرسة",
  "Mathematics Teacher": "معلم الرياضيات",
  ...
  "Max Score": "الدرجة الكلية",
  "Grade Level": "الصف",
  Letter: "التقدير الحرفي",
  Remarks: "ملاحظات",
  "Homework Assignments": "واجبات الدرس",
  Tasks: "المهام",
  ...
  "Homework Title is required.": "عنوان الواجب مطلوب.",
  "Deadline Date is required.": "تاريخ الموعد النهائي مطلوب.",
  "At least one homework question is required.": "يجب إضافة سؤال واحد على الأقل للواجب.",
  "Question text is required.": "نص السؤال مطلوب.",
  "At least two answer choices are required.": "يجب إضافة اختيارين للإجابة على الأقل.",
  "Mark one answer as correct.": "حدد إجابة واحدة على أنها صحيحة.",
  "The correct answer choice cannot be empty.": "لا يمكن أن يكون اختيار الإجابة الصحيحة فارغًا.",
  "Homework form is unavailable. Reopen it and try again.": "نموذج الواجب غير متاح. أعد فتحه وحاول مرة أخرى.",
  "Homework context is unavailable. Reopen the lesson and try again.": "بيانات الواجب غير متاحة. أعد فتح الدرس وحاول مرة أخرى.",
  ...
  "Changes saved successfully": "تم حفظ التعديلات بنجاح",
  "Item deleted successfully": "تم حذف العنصر بنجاح",
  "Item archived. You can view it from archived items.": "تمت أرشفة العنصر. يمكنك عرضه من العناصر المؤرشفة.",
  "Publish Homework": "نشر واجب",
  "Publish Task": "نشر مهمة",
  "Publish Test": "نشر اختبار",
  ...
  "Deadline Date": "تاريخ التسليم",
  "Choose a CSV file": "اختر ملف CSV",
  "Match CSV columns": "مطابقة أعمدة CSV",
  "Validate & Import": "تحقق واستورد",
  "Rows needing attention": "صفوف تحتاج إلى مراجعة",
  "Nothing is saved until you confirm.": "لن يتم حفظ أي بيانات حتى تؤكد الاستيراد.",
  ...
  "PDF Materials": "مواد مستندية",
  "PDF up to 50MB": "مستند حتى 50 ميجابايت",
  ...
  "No subject assigned yet.": "لم يتم تعيين مادة لهذا الفصل بعد.",
  "Please complete the lesson title and date.": "يرجى إكمال عنوان الدرس وتاريخه.",
  "Lesson saved successfully.": "تم حفظ الدرس بنجاح.",
  "Could not create lesson.": "تعذر إنشاء الدرس.",
  "Due:": "موعد التسليم:",
  question: "سؤال",
  questions: "أسئلة",
  Create: "إنشاء",
  ...
  April: "أبريل",
  May: "مايو",
  "Manage all schools and platform operations": "إدارة جميع المدارس وعمليات المنصة",
  "Manage your school, staff, and academics": "إدارة المدرسة والموظفين والشؤون الأكاديمية",
  "Create lessons, homework, and track students": "إنشاء الدروس والواجبات ومتابعة الطلاب",
  "Access courses, complete homework and tests": "الوصول للمقررات وإنجاز الواجبات والاختبارات",
  "Monitor your child's progress and grades": "متابعة تقدم الابن ودرجاته",
}
...
const ARABIC_WORDS: Record<string, string> = {
  ...
  Progress: "تقدم",
  Total: "إجمالي",
  "Select a lesson to open its details, attendance, attachments and homework.": "اختر درسًا لعرض تفاصيله والحضور والمرفقات والواجبات.",
  Set: "مسند",
  Latest: "الأحدث",
  Student: "طالب",
  Teacher: "معلم",
  ...
  Parent: "ولي الأمر",
  Guardian: "الوصي",
  "Parent / Guardian": "ولي الأمر / الوصي",
  Form: "نموذج",
  image: "صورة",
  jpg: "صورة",
  files: "ملفات",
...
Object.assign(ARABIC_TRANSLATIONS, {
  ...
  "Subscription Plan": "باقة الاشتراك",
  "e.g. Greenfield Academy": "مثال: أكاديمية جرينفيلد",
  "e.g. Mr. John Adeyemi": "مثال: الأستاذ أحمد محمد",
...
Object.assign(ARABIC_TRANSLATIONS, {
  ...
  "Mark attendance for the selected lesson, then save it to Supabase.": "سجّل حضور الدرس المحدد ثم احفظه في النظام.",
  "Mark all present": "تحديد الكل حاضر",
  "Save Attendance": "حفظ الحضور",
  "Saving...": "جارٍ الحفظ...",
  "Saved in this lesson": "تم الحفظ في هذا الدرس",
  "Not marked yet": "لم يتم التسجيل بعد",
  Late: "متأخر",
  Excused: "بعذر",
...
Object.assign(ARABIC_TRANSLATIONS, {
  ...
  "e.g. Class A": "مثال: الفصل أ",
  "e.g. Class A or فصل أ": "مثال: الفصل أ",
  "Select a valid grade level first.": "اختر مرحلة دراسية صالحة أولاً.",
  "Create an academic year and set it as current before adding classes.": "أنشئ عامًا دراسيًا وحدده كعام حالي قبل إضافة الفصول.",
  "School, current academic year, and grade level are required.": "المدرسة والعام الدراسي الحالي والمرحلة الدراسية مطلوبة.",
...
Object.assign(ARABIC_TRANSLATIONS, {
  ...
  "No class data yet": "لا توجد بيانات للفصول حتى الآن",
  "Your classes, lessons, homework, tests, and enrollments will appear here automatically from Supabase.": "ستظهر فصولك ودروسك وواجباتك واختباراتك وتسجيلات الطلاب هنا تلقائيًا من النظام.",
  "No teachers yet": "لا يوجد معلمون حتى الآن",
  "Add or invite a teacher to start assigning subjects and classes.": "أضف معلمًا أو أرسل إليه دعوة لبدء تعيين المواد والفصول.",
  "Enter the teacher name and email.": "أدخل اسم المعلم وبريده الإلكتروني.",
  "Teacher invited successfully": "تمت دعوة المعلم بنجاح.",
  "One teacher": "معلم واحد",
  "One student": "طالب واحد",
  "Upload CSV": "رفع ملف CSV",
  "Required CSV columns": "أعمدة CSV المطلوبة",
  "Student CSV columns": "أعمدة CSV الخاصة بالطلاب",
  "Each valid email receives an invitation. Existing accounts and duplicate rows are rejected.": "سيتم إرسال دعوة إلى كل بريد إلكتروني صالح. تُرفض الحسابات الموجودة والصفوف المكررة.",
  "Download teacher CSV example": "تنزيل نموذج CSV للمعلمين",
  "Download student CSV example": "تنزيل نموذج CSV للطلاب",
  "Import and invite teachers": "استيراد المعلمين وإرسال الدعوات",
  "Import students into class": "استيراد الطلاب إلى الفصل",
  "Sending invitations...": "جارٍ إرسال الدعوات...",
  "Inviting and enrolling...": "جارٍ إرسال الدعوات وتسجيل الطلاب...",
  "Choose CSV file": "اختيار ملف CSV",
  "No file chosen": "لم يتم اختيار ملف",
  "Fix these errors:": "يرجى تصحيح الأخطاء التالية:",
  "The class is selected above and applies to every row. National ID is optional; when supplied it must contain exactly 14 digits.": "يُطبق الفصل المحدد أعلاه على جميع الصفوف. الرقم القومي اختياري، وإذا أُدخل فيجب أن يتكون من 14 رقمًا بالضبط.",
  "full_name,email": "full_name,email",
  "full_name,email,national_id": "full_name,email,national_id",
  "Assign Teachers": "تعيين المعلمين",
  "Save Assignments": "حفظ التعيينات",
  "Class assignments updated": "تم تحديث تعيينات الفصل بنجاح.",
  "Add Timetable Entry": "إضافة حصة إلى الجدول",
  "Edit Timetable Entry": "تعديل حصة في الجدول",
  "Time Slot": "الحصة",
  "Choose a class and current academic year first.": "اختر الفصل والعام الدراسي الحالي أولًا.",
  "Choose the subject and teacher first.": "اختر المادة والمعلم أولًا.",
  "Timetable entry updated": "تم تحديث الحصة في الجدول.",
  "Timetable entry created": "تمت إضافة الحصة إلى الجدول.",
  "Timetable entry removed": "تم حذف الحصة من الجدول.",
  "Create Entry": "إنشاء الحصة",
  "No students yet": "لا يوجد طلاب حتى الآن",
  "Add a student to start managing enrollment, parents, and attendance.": "أضف طالبًا لبدء إدارة التسجيل وأولياء الأمور والحضور.",
  "No enrolled students": "لا يوجد طلاب مسجلون",
  "Active students in this class will appear here for attendance recording.": "سيظهر هنا الطلاب النشطون المسجلون في هذا الفصل لتسجيل حضورهم.",
  Workload: "عبء العمل",
  ...
  Overdue: "متأخر",
  "View All": "عرض الكل",
  "Announcements will appear here after they are published.": "ستظهر الإعلانات هنا بعد نشرها.",
  "Working days updated": "تم تحديث أيام العمل بنجاح",
  "This time slot overlaps an existing time slot.": "تتعارض هذه الحصة مع حصة موجودة. اختر وقتًا آخر.",
  "time slot overlaps an existing time slot": "تتعارض هذه الحصة مع حصة موجودة. اختر وقتًا آخر.",
  "Complete the academic year form first.": "أكمل نموذج العام الدراسي أولاً.",
  "Complete the semester form first.": "أكمل نموذج الفصل الدراسي أولاً.",
  "Semester saved": "تم حفظ الفصل الدراسي بنجاح.",
  ...
  useEffect(() => {
    ...
    const updateText = (node: Text) => {
      ...
      if (original === undefined) {
        ...
        const previouslyRendered = translate(original, language, original)
        // React may reuse the same Text node when a view changes. If its value
        // differs from what this translator last rendered, treat it as new
        // source text instead of restoring the previous tab's label.
        if (current !== previouslyRendered) original = current
      }
    ...
    const updateElement = (element: Element) => {
      ...
      ;["placeholder", "title", "aria-label"].forEach((attribute) => {
        ...
        if (!(attribute in values)) {
          ...
          const previouslyRendered = translate(values[attribute], language, values[attribute])
          if (current !== previouslyRendered) values[attribute] = current
        }
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    window.localStorage.setItem("nibras-language", language)
  }, [language])
  return (
    <LanguageContext.Provider value={{ language, setLanguage }}>
      <BilingualContent language={language} />
      {children}
...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-muted hover:bg-secondary text-sm font-semibold text-foreground transition-colors"
...
export const ANNOUNCEMENTS = [
  {
    ...
    body: "Mid-term examinations will commence on April 28. All students are required to report 30 minutes early.",
    audience: "All",
    date: "Apr 10, 2024",
    author: "School Admin",
  },
  {
    ...
    body: "Annual parent-teacher conference scheduled for May 5. Parents are encouraged to register in advance.",
    audience: "Parents",
    date: "Apr 8, 2024",
    author: "School Admin",
  },
  {
    ...
    body: "The school has procured new laboratory equipment. All science teachers should review the inventory.",
    audience: "Teachers",
    date: "Apr 6, 2024",
    author: "School Admin",
  },
  {
    ...
    body: "Annual sports day will be held on May 15. Students should register their preferred events by May 1.",
    audience: "Students",
    date: "Apr 4, 2024",
    author: "School Admin",
  },
...
export const ATTENDANCE_DATA = [
  ...
  { month: "Feb", present: 17, absent: 3 },
  { month: "Mar", present: 20, absent: 0 },
  { month: "Apr", present: 15, absent: 2 },
]
...
export function LoadingState({ label, title, description }: { label?: string; title?: string; description?: string }) {
  const { t } = useTranslation()
...
export function EmptyState({ title = "Nothing here yet", description = "New items will appear here when available.", action }: { title?: string; description?: string; action?: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-40 flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-card p-8 text-center">
      <Inbox className="mb-3 h-8 w-8 text-primary/60" />
      <p className="text-sm font-semibold text-foreground">{t(title, title)}</p>
      <p className="mt-1 max-w-sm text-xs text-muted-foreground">{t(description, description)}</p>
...
export function ErrorState({ title = "We could not load this data", description = "Please try again.", onRetry }: { title?: string; description?: string; onRetry?: () => void }) {
  const { t } = useTranslation()
  return (
    <div className="flex min-h-40 flex-col items-center justify-center rounded-2xl border border-red-100 bg-red-50/50 p-8 text-center">
      <TriangleAlert className="mb-3 h-8 w-8 text-red-500" />
      <p className="text-sm font-semibold text-foreground">{t(title, title)}</p>
      <p className="mt-1 text-xs text-muted-foreground">{t(description, description)}</p>
      {onRetry && (
        <button onClick={onRetry} className="mt-4 rounded-lg bg-primary px-4 py-2 text-xs font-semibold text-white">
          {t("Try again")}
        </button>
      )}
    </div>
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-28 h-28">
        <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
          ...
          <circle cx="50" cy="50" r={r} fill="none" stroke="#7C5CBF" strokeWidth="10" strokeDasharray={circ} strokeDashoffset={offset} strokeLinecap="round" className="transition-all duration-700" />
        </svg>
    ...
    <div className="flex items-center justify-between p-3 bg-muted rounded-xl">
      ...
      <div className="relative w-12 h-12">
        <svg viewBox="0 0 40 40" className="w-full h-full -rotate-90">
          ...
          <circle cx="20" cy="20" r={r} fill="none" stroke="#7C5CBF" strokeWidth="4" strokeDasharray={circ} strokeDashoffset={offset} strokeLinecap="round" />
        </svg>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        {items.map((item) => (
          ...
          >
            ...
            {(item.badge ?? 0) > 0 && (
              <span className={`flex h-5 min-w-5 shrink-0 items-center justify-center rounded-full px-1 text-[10px] font-bold ${active === item.id ? "bg-white text-primary" : "bg-primary text-white"}`}>
...
function NotificationBell({ userId }: { userId?: string | null }) {
  ...
  const emptyDescription = language === "ar" ? "ستظهر هنا الإشعارات الجديدة القادمة من النظام." : "New notifications from Supabase will appear here."
  const unreadLabel = unreadCount > 0 ? (language === "ar" ? "إشعارات غير مقروءة" : "Unread notifications") : language === "ar" ? "لا توجد إشعارات غير مقروءة" : "No unread notifications"
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      >
        ...
        {unreadCount > 0 && <span className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[9px] font-bold text-white">{badgeText}</span>}
      </button>

      {open && (
        <div className="absolute top-11 z-40 w-80 max-w-[calc(100vw-2rem)] rounded-2xl border border-border bg-card p-3 shadow-xl" style={{ insetInlineEnd: 0 }}>
          <div className="mb-3 flex items-start justify-between gap-3 px-1">
            <div>
              <p className="text-sm font-bold text-foreground">{title}</p>
              <p className="text-xs text-muted-foreground">{loading ? loadingLabel : unreadLabel}</p>
            </div>
            <div className="flex items-center gap-2">
              {unreadCount > 0 && <span className="inline-flex min-w-6 items-center justify-center rounded-full bg-primary/10 px-2 py-1 text-[10px] font-bold text-primary">{badgeText}</span>}
              <button
                type="button"
          ...
          <div className="max-h-80 space-y-2 overflow-y-auto">
            ...
            {latestNotifications.map((notification) => {
              const heading = notification.title?.trim() || notification.body?.trim().slice(0, 72) || (language === "ar" ? "إشعار" : "Notification")
                ...
                <div key={notification.id} className="rounded-xl border border-border bg-muted/30 px-3 py-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-2 text-[11px] text-muted-foreground">{formatNotificationTimestamp(notification.created_at, language)}</p>
                    </div>
                  </div>
                </div>
              )
...
export function AppShell({
  ...
  return (
    <div className="flex h-screen bg-background font-[Plus_Jakarta_Sans,sans-serif] overflow-hidden">
      ...
      >
        <Sidebar
          items={navItems.map((item) => ({ ...item, badge: navBadges?.[item.id] ?? item.badge }))}
          active={activeView}
          onSelect={(id) => {
            onSelect(id)
...
export function LessonWorkspace({
  ...
  const defaultAttendance = [
    ["Charlie Rawal", "53", "250", "up"],
    ["Ariana Agarwal", "88", "212", "down"],
    ["Mohamed Salah", "84", "208", "up"],
    ["Mariam Ahmed", "79", "196", "up"],
    ["Youssef Ali", "74", "189", "down"],
    ["Salma Hassan", "69", "175", "up"],
  ] as const
  const defaultGroups = [
  ...
  return (
    <section className="rounded-2xl border border-[#EDE5F4] bg-white p-4 sm:p-7 shadow-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>
      <div className="mb-7 flex flex-wrap items-center gap-3">
        <button onClick={onBack} aria-label="Back" className="grid h-9 w-9 place-items-center rounded-xl text-[#172B5D] transition hover:bg-[#F5F0FF]">
          <ChevronLeft className="h-5 w-5" />
        </button>
        <div className="min-w-0 flex-1">
          <h2 className="truncate text-xl font-bold text-[#172B5D]">{className}</h2>
          <p className="mt-0.5 text-xs text-[#8B8FA3]">{lessonTitle}</p>
        </div>
        {canAddLesson && (
          <button
            onClick={onAddLesson}
            ...
            return (
              <div key={group.title}>
                <div className="mb-3 flex items-center justify-between">
                  <h3 className="text-base font-semibold text-[#243767]">{group.title}</h3>
                  {canCreateAssignments && create && (
                    <button onClick={create} className="inline-flex items-center gap-1 rounded-lg bg-[#F5F0FF] px-3 py-1.5 text-xs font-bold text-[#955AC3] hover:bg-[#EADAF5]">
                      <Plus className="h-3.5 w-3.5" /> {group.title === "Homework" ? "Add Homework" : "Add Task"}
                    </button>
                  )}
                </div>
                <div className="grid gap-3 sm:grid-cols-2">
                  {group.items.map((item, index) => {
                    const handleClick =
                      item.onClick ?? (item.href && item.href !== "#" ? () => window.open(item.href, "_blank", "noopener,noreferrer") : group.title === "Homework" ? onOpenHomework : undefined)
                    return (
                      <button
                        key={`${group.title}-${item.title}-${index}`}
                        onClick={handleClick}
                        className="group min-h-36 rounded-xl border border-[#E7D8F4] bg-white p-4 text-left transition hover:-translate-y-0.5 hover:shadow-md"
                      >
                        <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-[#F7F0FB] text-[#955AC3]">
                          <Icon className="h-5 w-5" />
                        </div>
                        <p className="text-sm font-semibold text-[#243767]">{item.title}</p>
                        <div className="mt-2 flex items-center gap-2 text-[11px] text-[#8B8FA3]">
                          <BookOpen className="h-3.5 w-3.5" /> {item.metaOne ?? String(index + 3)} <span className="h-3 w-px bg-[#DCCAE9]" /> <Users className="h-3.5 w-3.5" /> {item.metaTwo ?? "99"}
                        </div>
                      </button>
                    )
                  })}
                </div>
                {group.items.length === 0 && <div className="rounded-xl border border-dashed border-[#E7D8F4] px-4 py-6 text-center text-sm text-[#8B8FA3]">Nothing here yet</div>}
              </div>
            )
          })}
        </div>
        <aside className="overflow-hidden rounded-2xl border border-[#F0EAF5] bg-white">
          <div className="border-b border-[#F4EEF7] px-5 py-4">
            <h3 className="text-base font-semibold text-[#243767]">Attendance</h3>
            <p className="mt-1 text-xs text-[#8B8FA3]">Class activity and participation</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full min-w-[330px] text-left">
              <thead className="text-[10px] uppercase tracking-wide text-[#9AA0B4]">
                <tr>
              ...
              <tbody>
                {attendance.map((row, index) => (
                  <tr key={`${row.name}-${index}`} className="border-t border-[#F7F2F9] text-xs">
                    <td className="px-4 py-3">
                      <span className="rounded bg-[#F5F0FF] px-1.5 py-1 text-[#6E5D8B]">{index + 1}</span>
                    </td>
                    <td className="py-3 font-semibold text-[#34446E]">
                      <span className="mr-2 inline-block h-2 w-2 rounded-full" style={{ background: row.trend === "down" ? "#EF7C8E" : "#36B7A2" }} />
                      {row.name}
                    </td>
                    <td className="px-3 py-3 text-[#6B7188]">{row.rank}</td>
                    <td className="px-4 py-3 text-right text-[#6B7188]">{row.hours}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          {attendance.length === 0 && <div className="px-5 py-6 text-center text-sm text-[#8B8FA3]">Nothing here yet</div>}
        </aside>
      </div>
    </section>
  )
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-8" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 max-w-5xl w-full">
        {ROLES.map((r) => (
          <button
            key={r.id}
            onClick={() => onSelect(r.id as Portal)}
...
const SUBSCRIPTION_PLANS_DEFAULT = [
  { id: 1, name: "Basic", price: 99, period: "mo", maxStudents: 300, maxTeachers: 20, features: ["Core LMS", "Homework builder", "Timetable"], color: "#6B7280", schools: 6 },
  {
    ...
    maxStudents: 800,
    maxTeachers: 60,
    features: ["All Basic features", "Analytics dashboard", "Parent portal", "Messaging"],
    color: "#3B82F6",
    schools: 8,
  },
  {
    ...
    maxStudents: 2000,
    maxTeachers: 150,
    features: ["All Standard features", "Advanced reports", "API access", "Priority support", "Custom branding"],
    color: "#7C5CBF",
    schools: 10,
  },
]
  ...
  const savePlan = () => {
    ...
    if (editingPlan) {
      setPlans((prev) =>
        prev.map((p) =>
          p.id === editingPlan.id
            ? { ...p, name: planForm.name, price: Number(planForm.price), maxStudents: Number(planForm.maxStudents), maxTeachers: Number(planForm.maxTeachers), features: feats }
            : p,
        ),
      )
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 bg-card rounded-2xl p-5 border border-border shadow-sm">
                ...
                <ResponsiveContainer width="100%" height={220}>
                  ...
                  >
                    <defs>
                      <linearGradient id="sa-grad1" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <tbody>
                    {filteredSchools.map((s) => (
                      <tr key={s.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <Badge color={s.plan === "Premium" ? "purple" : s.plan === "Standard" ? "blue" : "gray"}>{s.plan}</Badge>
                        </td>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1.5">
                            ...
                            {s.status === "inactive" ? (
                              ...
                              <button
                                onClick={() => setShowDeactivate(s.id)}
                  ...
                  <tbody>
                    {filteredLeads.map((l) => (
                      <tr key={l.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                        ...
                        <td className="px-4 py-3 text-sm text-muted-foreground max-w-[180px] truncate" title={l.address}>
                          {l.address}
                        </td>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <button
                              onClick={() => setShowContactModal(l.id)}
                              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-secondary text-xs font-medium text-primary hover:bg-primary hover:text-white transition-all"
                            >
                            ...
                            <div className="relative group">
                              ...
                              <div className="absolute right-0 top-8 z-50 bg-card border border-border rounded-xl shadow-lg py-1 w-36 hidden group-hover:block">
                                {["New", "Contacted", "Converted"].map((st) => (
                                  <button
                                    key={st}
                                    onClick={() => changeLeadStatus(l.id, st)}
                                    className={`w-full text-left px-3 py-2 text-xs hover:bg-muted transition-colors ${l.status === st ? "font-semibold text-primary" : "text-foreground"}`}
                                  >
                                    {st}
                                  </button>
                                ))}
        ...
        {view === "analytics" && (
          <div className="space-y-6">
              ...
              <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
                ...
                <ResponsiveContainer width="100%" height={240}>
                  <RPieChart>
                    ...
                    >
                      {["#7C5CBF", "#A78BFA", "#DDD6FE"].map((c, i) => (
                        <Cell key={`plan-cell-${i}`} fill={c} />
                      ))}
                    </Pie>
                    <Tooltip />
                  </RPieChart>
            ...
            <div className="flex justify-end">
              <Btn icon={<Download className="w-4 h-4" />} variant="secondary">
                Export Report
              </Btn>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <p className="text-sm text-muted-foreground">
                {plans.length} active plans · {schools.length} schools subscribed
              </p>
              <Btn icon={<Plus className="w-4 h-4" />} onClick={() => openPlanModal()}>
                Create Plan
              </Btn>
            </div>
                ...
                <div key={p.id} className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 space-y-1.5 text-xs text-muted-foreground">
                      <p>
                        Up to <strong className="text-foreground">{p.maxStudents.toLocaleString()}</strong> students
                      </p>
                      <p>
                        Up to <strong className="text-foreground">{p.maxTeachers}</strong> teachers
                      </p>
                    </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl border border-green-200">
              ...
              <p className="text-sm text-green-800">
                You are about to activate <strong>{schools.find((s) => s.id === showActivate)?.name}</strong>. The school admin will be notified by email.
              </p>
            </div>
            <div className="flex gap-3">
              <Btn onClick={() => activateSchool(showActivate!)} className="flex-1">
                Confirm Activation
              </Btn>
              <Btn variant="secondary" onClick={() => setShowActivate(null)}>
                Cancel
              </Btn>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-amber-50 rounded-xl border border-amber-200">
              ...
              <p className="text-sm text-amber-800">
                Deactivating <strong>{schools.find((s) => s.id === showDeactivate)?.name}</strong> will suspend access for all users. You can reactivate at any time.
              </p>
            </div>
            <div className="flex gap-3">
              <Btn onClick={() => deactivateSchool(showDeactivate!)} className="flex-1 !bg-amber-500 hover:!bg-amber-600">
                Deactivate
              </Btn>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-red-50 rounded-xl border border-red-200">
              ...
              <p className="text-sm text-red-800">
                This will permanently delete <strong>{schools.find((s) => s.id === showDelete)?.name}</strong> and all associated data. This action cannot be undone.
              </p>
            </div>
            <div className="flex gap-3">
              <Btn onClick={() => deleteSchool(showDelete!)} className="flex-1 !bg-red-500 hover:!bg-red-600">
                Delete Permanently
              </Btn>
              <Btn variant="secondary" onClick={() => setShowDelete(null)}>
                Cancel
              </Btn>
            </div>
          </div>
              ...
              return l ? (
                <div>
                  ...
                  <div className="mt-3">
                    ...
                    <textarea
                      rows={4}
                      className="w-full px-3 py-2 rounded-xl border border-border bg-muted text-sm outline-none focus:ring-2 focus:ring-primary/30 resize-none"
                      defaultValue={`Dear ${l.owner},\n\nWe would like to discuss how Nibras can serve ${l.schoolName}…`}
                    />
                  </div>
                  <div className="flex gap-3 pt-2">
                    <Btn
                      ...
                      onClick={() => {
                        changeLeadStatus(l.id, "Contacted")
                        setShowContactModal(null)
                        showToast("Message sent and status updated to Contacted.")
                      }}
                      className="flex-1"
                    >
                      Send Message
                    </Btn>
                    <Btn variant="secondary" onClick={() => setShowContactModal(null)}>
                      Cancel
                    </Btn>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 rounded-xl border border-border bg-muted text-sm outline-none focus:ring-2 focus:ring-primary/30 resize-none"
                placeholder="All Standard features, Custom branding, API access"
              />
            </div>
            <div className="flex gap-3 pt-2">
              <Btn onClick={savePlan} className="flex-1">
                {editingPlan ? "Save Changes" : "Create Plan"}
              </Btn>
              <Btn variant="secondary" onClick={() => setShowPlanModal(false)}>
                Cancel
              </Btn>
            </div>
          </div>
